...
// https://www.cnblogs.com/Again/p/6611579.html
// libsshœ¬‘ÿ¬∑æ∂:https://red.libssh.org/attachments/download/161/libssh-0.7.1-msvc.zip
...
ssh_session connect_ssh(const char *host, const char *user,char * pass,int verbosity){
	ssh_session session;
	int auth=0;
